...
"""
# a neuron has a value, has a list of output and a list of input neurons to it 
class Neuron:
    def __init__(self, inbound_neurons=[]):
        ...
        for n in self.inbound_neurons:  # notice n has to be a neuron to have method outbound_neurons 
...
# an input neuron is a type of neuron that has no inbound node 
class Input(Neuron):
    def __init__(self):
    ...
    # of the previous neurons from self.inbound_neurons  '' amir = i think probably from forward method of neuron ? ''
    #
    # Example:
...
class Add(Neuron):
    ...
    def forward(self):
        ...
        """
        #return 10
        # return sum([n.value for n in self.inbound_neurons])
